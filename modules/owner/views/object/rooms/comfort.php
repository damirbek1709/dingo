...
$this->params['breadcrumbs'][] = ['label' => $object_title, 'url' => ['object/view', 'id' => $room_id,'object_id'=>$object_id]];
$this->params['breadcrumbs'][] = ['label' => $room['room_title'], 'url' => ['room', 'id' => $object_id]];
